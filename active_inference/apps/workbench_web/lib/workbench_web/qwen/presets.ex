defmodule WorkbenchWeb.Qwen.Presets do
  ...
  defp chips(:session, _),
    do: [
      ...
      c(
        ...
        "Why does this session matter in the arc of the chapter?"
      ),
      c("math", "Show the math", "Walk me through the math behind this session, step by step."),
      c(
        "lab",
        "Try it in a lab",
        "Which lab on this page should I try, and what beat should I start on?"
      ),
  ...
  defp chips(:chapter, _),
    do: [
      ...
      c(
        "eq",
        "Pick one equation",
        "Pick one equation from this chapter to learn first and justify the pick."
      )
    ]
  ...
  defp chips(:cookbook_recipe, _),
    do: [
      c(
        ...
        "Walk me through the math of this recipe, symbol by symbol."
      ),
      c(
        "vs_session",
        "How is this different?",
        "How does this recipe differ from my current session — what's the bridge?"
      ),
      c(
        "run",
        "Run this recipe",
        "Which runtime parameters should I use on the first run, and what will I see?"
      ),
      c(
        "simplest",
        "Simplest version?",
        "What's the simplest toy version of this recipe I can reason about?"
      )
    ]
  ...
  defp chips(:labs_run, %{episode: nil}),
    do: [
      c(
        "predict",
        "What will happen?",
        "What will happen when I press Run? Walk through the first 3 ticks."
      ),
      c(
        "params",
        "Why these params?",
        "Why these parameters? What would be a sensible adjustment?"
      ),
  ...
  defp chips(:studio_agent, _),
    do: [
      ...
      c(
        "dirichlet",
        "Dirichlet updates",
        "What has this agent learned from Dirichlet updates so far?"
      ),
  ...
  defp chips(:equation, _),
    do: [
      ...
      c(
        "deps",
        "What depends on it?",
        "Which other equations depend on this one — what's the chain?"
      ),
  ...
  defp chips(:equations_index, _),
    do: [
      ...
      c(
        "first",
        "Learn one first",
        "If I could only learn one equation, which should it be and why?"
      )
    ]
  ...
  defp chips(:guide, %{guide_topic: :blocks}),
    do: [
      c(
        "curious",
        "Block for a curious agent",
        "Which block do I need for a curious agent? Explain the pipeline."
      ),
      c(
        "smallest",
        "Smallest useful topology",
        "What's the smallest useful topology I can drop on the Builder canvas?"
      ),
  ...
  defp chips(:guide, %{guide_topic: :cookbook}),
    do: [
      c(
        ...
        "Based on the real-world path, pick a cookbook recipe and explain why."
      ),
      c(
        "structure",
        "How recipes work",
        "How is a recipe card structured — what are the key fields?"
      )
    ]
  ...
  defp chips(:guide, %{guide_topic: :studio}),
    do: [
      ...
      c(
        "lifecycle",
        "Lifecycle model",
        "Walk me through the live / stopped / archived / trashed lifecycle."
      )
    ]
  ...
  defp chips(:builder, _),
    do: [
      c(
        ...
        "Build the smallest useful graph that teaches one concept."
      ),
      c(
        "explain",
        "Explain the banner",
        "Explain the recipe banner at the top — what does this spec do?"
      ),
      c(
        "compile",
        "What will compile do?",
        "What will pressing Compile actually do under the hood?"
      )
    ]
  ...
  defp chips(:learning_hub, _),
    do: [
      c(
        "start",
        "Where to start",
        "Given my current progress, which chapter should I open next?"
      ),
      c(
        "paths",
        "Explain the paths",
        "Explain the four learning paths (kid / real / equation / derivation)."
      ),
  ...
  defp chips(:studio_index, _),
    do: [
      ...
      c(
        "states",
        "State machine",
        "Walk me through the live / stopped / archived / trashed states."
      )
    ]
  ...
  defp chips(:studio_new, _),
    do: [
      c(
        "flows",
        "3 flows",
        "Explain the three flows (Attach / Spec / Recipe) and which I should pick."
      ),
  ...
  defp chips(:studio_trash, _),
    do: [
      c(
        "restore",
        "Restore safely",
        "What happens when I restore an agent, and what state does it come back in?"
      ),
  ...
  defp chips(:glass_agent, _),
    do: [
      c(
        "river",
        "Read the signal river",
        "Read the last 5 signals and tell me what the agent is doing."
      ),
  ...
  defp chips(:world, _),
    do: [
      c(
        "explain",
        "Explain the world",
        "Explain what this world is testing — what would a good agent do?"
      ),
  ...
  defp episode_chips do
    [
      c(
        "why",
        "Why that action?",
        "Why did the agent pick that action? Cite the live episode state."
      ),
      c("depth", "Raise policy depth?", "What would change if I raised policy depth by 2?"),
      c(
        "epistemic",
        "Epistemic or pragmatic?",
        "Is the agent being epistemic or pragmatic right now? Cite the posterior."
      ),
      c(
        "heatmap",
        "Read the heatmap",
        "What does the belief heatmap tell you about the agent's uncertainty?"
      ),
